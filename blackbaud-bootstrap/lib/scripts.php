...
function roots_scripts() {
	...
	wp_enqueue_style("boostrap_css", "//cdn.jsdelivr.net/bootstrap/3.1.1/css/bootstrap.min.css", false, null);
	...
	// Modernizr CDN
	wp_register_script("modernizr_cdn", "//cdn.jsdelivr.net/modernizr/2.7.1/modernizr.min.js", array(), null, false);
	
	// Bootstrap JavaScript CDN
	wp_register_script("bootstrap_cdn", "//cdn.jsdelivr.net/bootstrap/3.1.1/js/bootstrap.min.js", array(), null, true);
	...
	wp_enqueue_script("modernizr_cdn");
	wp_enqueue_script("bootstrap_cdn");
