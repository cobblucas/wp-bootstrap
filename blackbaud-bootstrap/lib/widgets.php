...
function roots_widgets_init() {
	...
	'name'          => __('Sidebar - Internal Pages', 'roots'),
	'id'            => 'sidebar-primary',
	...
	register_sidebar(array(
	'name'          => __('Sidebar - Home Page', 'roots'),
	'id'            => 'sidebar-home',
	'before_widget' => '<section class="widget %1$s %2$s">',
	'after_widget'  => '</section>',
	'before_title'  => '<h3>',
